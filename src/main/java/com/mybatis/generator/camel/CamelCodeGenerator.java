package com.mybatis.generator.camel;

import com.mybatis.generator.CodeGenerator;

/**
 * 项目代码生成器(驼峰，字段和实体属性都是一样的)
 *
 * @author 清歌
 * @version v1.1
 ...
 */
public class CamelCodeGenerator {
...
//       CodeGenerator.password="**";
    ...
    public static void main(String args[]){
       // 如果你项目中repository带mysql，请将isCreateMysqlPachage置为true，否则置为false
       CodeGenerator.createCode(true,true);
